...
const { getBrowserOsDetails } = require('faunadb/src/_util')
var util = require('faunadb/src/_util')
var errors = require('faunadb/src/_http/errors')
...
function HttpClient(options) {
  ...
  this._adapter = useHttp2Adapter
    ? new (require('faunadb/src/_http/http2Adapter'))({
        http2SessionIdleTime: options.http2SessionIdleTime,
      })
    : new (require('faunadb/src/_http/fetchAdapter'))({
        isHttps: isHttps,
        fetch: options.fetch,
