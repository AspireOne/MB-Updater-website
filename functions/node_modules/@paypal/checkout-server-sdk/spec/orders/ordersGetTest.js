...
require('@paypal/checkout-server-sdk/spec/spec_helper');

const chai = require('chai');
const client = require('@paypal/checkout-server-sdk/spec/test_harness').client();
const OrdersGetRequest = paypal.orders.OrdersGetRequest;
const CreateOrder = require('@paypal/checkout-server-sdk/spec/orders/ordersCreateTest').CreateOrder;
