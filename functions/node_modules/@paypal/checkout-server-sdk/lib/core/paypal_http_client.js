...
const AccessToken = require('@paypal/checkout-server-sdk/lib/core/access_token').AccessToken;
const AccessTokenRequest = require('@paypal/checkout-server-sdk/lib/core/access_token_request').AccessTokenRequest;
const sdkVersion = require('@paypal/checkout-server-sdk/package.json').version;
const TokenCache = require('@paypal/checkout-server-sdk/lib/core/token_cache').TokenCache;
