...
const authToken = require('@paypal/checkout-server-sdk/samples/Common/payPalClient').authentication;
const checkoutNodeJssdk = require('@paypal/checkout-server-sdk');
const prettyPrint = require('@paypal/checkout-server-sdk/samples/Common/payPalClient').prettyPrint;
/**
