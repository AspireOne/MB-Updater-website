const createOrder = require('@paypal/checkout-server-sdk/samples/CaptureIntentExamples/createOrder').createOrder;
const captureOrder = require('@paypal/checkout-server-sdk/samples/CaptureIntentExamples/captureOrder').captureOrder;
