...
let url = require('url');
let Encoder = require('@paypal/paypalhttp/lib/paypalhttp/encoder').Encoder;
let zlib = require('zlib');
let Json = require('@paypal/paypalhttp/lib/paypalhttp/serializer/json').Json;
let Text = require('@paypal/paypalhttp/lib/paypalhttp/serializer/text').Text;
let Multipart = require('@paypal/paypalhttp/lib/paypalhttp/serializer/multipart').Multipart;
let FormEncoded = require('@paypal/paypalhttp/lib/paypalhttp/serializer/form_encoded').FormEncoded;
